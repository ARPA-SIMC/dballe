...
!     Database login
      call idba_messages(dbahandle, "BUFR", infile, "")
      call ensure_no_error("messages")
...
!     Advance to the next message
      ...
      call ensure("voglioquesto result", i.eq.9)
...
!     And the other messages
      ...
      call ensure("voglioquesto result", i.eq.193)
      ...
      call ensure("voglioquesto result", i.eq.182)
      ...
      call ensure("voglioquesto result", i.eq.170)
      ...
      call ensure("voglioquesto result", i.eq.184)
      ...
      call ensure("voglioquesto result", i.eq.256)
      ...
      call ensure("voglioquesto result", i.eq.213)
