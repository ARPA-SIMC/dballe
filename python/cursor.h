...
typedef struct
{
    PyObject_HEAD std::shared_ptr<dballe::impl::CursorStation> cur;
} dpy_CursorStation;
...
typedef struct
{
    PyObject_HEAD std::shared_ptr<dballe::db::v7::cursor::Stations> cur;
} dpy_CursorStationDB;
...
typedef struct
{
    PyObject_HEAD std::shared_ptr<dballe::impl::CursorStationData> cur;
...
typedef struct
{
    PyObject_HEAD std::shared_ptr<dballe::db::v7::cursor::StationData> cur;
...
typedef struct
{
    PyObject_HEAD std::shared_ptr<dballe::impl::CursorData> cur;
} dpy_CursorData;
...
typedef struct
{
    PyObject_HEAD std::shared_ptr<dballe::db::v7::cursor::Data> cur;
} dpy_CursorDataDB;
...
typedef struct
{
    PyObject_HEAD std::shared_ptr<dballe::db::v7::cursor::Summary> cur;
} dpy_CursorSummaryDB;
...
typedef struct
{
    PyObject_HEAD std::shared_ptr<dballe::db::summary::Cursor<dballe::Station>>
        cur;
...
{
    PyObject_HEAD
        std::shared_ptr<dballe::db::summary::Cursor<dballe::DBStation>>
            cur;
...
typedef struct
{
    PyObject_HEAD std::shared_ptr<dballe::impl::CursorMessage> cur;
} dpy_CursorMessage;
...
PyObject* enqpy(db::summary::Cursor<Station>& cur, const char* key,
                unsigned len);
extern template PyObject* enqpy(db::summary::Cursor<Station>& cur,
                                const char* key, unsigned len);
extern template PyObject* enqpy(db::summary::Cursor<DBStation>& cur,
                                const char* key, unsigned len);
...
dpy_CursorSummaryDB*
cursor_create(std::shared_ptr<db::v7::cursor::Summary> cur);
dpy_CursorSummarySummary*
