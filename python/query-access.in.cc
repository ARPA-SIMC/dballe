                 ...
                 PyObject* val)
{
    switch (key) // mklookup
    {
        ...
        case "lat":      {
            int ival = dballe_int_lat_from_python(val);
            query.latrange.set(ival, ival);
        }
        case "lon": {
            int ival = dballe_int_lon_from_python(val);
            query.lonrange.set(ival, ival);
        }
        case "latmax":
            query.latrange.set(query.latrange.imin,
                               dballe_int_lat_from_python(val));
        case "latmin":
            query.latrange.set(dballe_int_lat_from_python(val),
                               query.latrange.imax);
        ...
        case "year":
            query.dtrange.min.year = query.dtrange.max.year =
                datetime_int16_from_python(val);
        case "month":
            query.dtrange.min.month = query.dtrange.max.month =
                datetime_int8_from_python(val);
        case "day":
            query.dtrange.min.day = query.dtrange.max.day =
                datetime_int8_from_python(val);
        case "hour":
            query.dtrange.min.hour = query.dtrange.max.hour =
                datetime_int8_from_python(val);
        case "min":
            query.dtrange.min.minute = query.dtrange.max.minute =
                datetime_int8_from_python(val);
        case "sec":
            query.dtrange.min.second = query.dtrange.max.second =
                datetime_int8_from_python(val);
        case "yearmax":
        ...
        case "var":
            ...
            query.varcodes.insert(varcode_from_python(val));
        ...
        default:
            PyErr_Format(PyExc_KeyError, "key %s not valid for a query", key);
