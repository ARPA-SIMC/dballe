...
| Environment | Status |
| ----------- | ------ |
| Fedora 24   | [![Build Status](https://badges.herokuapp.com/travis/ARPA-SIMC/dballe?branch=travis&env=DOCKER_IMAGE=fedora:24&label=fedora24)](https://travis-ci.org/ARPA-SIMC/dballe) |
