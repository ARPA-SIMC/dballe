/*
 * core/varinfo - Variable information
 *
 ...
 */
#define DBA_VAR(f, x, y) ((dballe::Varcode)( ((unsigned)(f)<<14) | ((unsigned)(x)<<8) | (unsigned)(y) ))
 ...
 */
#define DBA_STRING_TO_VAR(str) ((dballe::Varcode)( \
 ...
 */
#define DBA_VAR_F(code) (((code) >> 14) & 0x3)
/**
...
/**
 * Describes how a dballe::Varinfo has been altered: it is used for supporting
