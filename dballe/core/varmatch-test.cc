...
void Tests::register_tests()
{
    ...
    add_method("decimal", []() {
        ...
        wassert(
            actual((*Varmatch::parse("273<=B12101<=273.15"))(var)).istrue());
        wassert(
            actual((*Varmatch::parse("273.15<=B12101<=273.15"))(var)).istrue());
        wassert(
            actual((*Varmatch::parse("273.15<=B12101<=274"))(var)).istrue());
    ...
    add_method("string", []() {
        ...
        wassert(actual((*Varmatch::parse("emanuele<=B01011<=enrico"))(var))
                    .istrue());
        wassert(
            actual((*Varmatch::parse("enrico<=B01011<=enrico"))(var)).istrue());
        wassert(
            actual((*Varmatch::parse("enrico<=B01011<=paolo"))(var)).istrue());
        wassert(actual((*Varmatch::parse("daniele<=B01011<=emanuele"))(var))
                    .isfalse());
    });
    ...
    add_method("errors", []() {
        ...
        wassert_throws(wreport::error_consistency,
                       Varmatch::parse("B01011=!3"));
        wassert_throws(wreport::error_consistency,
                       Varmatch::parse("B01011><3"));
        wassert_throws(wreport::error_consistency,
                       Varmatch::parse("3<B01011>3"));
        wassert_throws(wreport::error_consistency,
                       Varmatch::parse("3>B01011>3"));
        wassert_throws(wreport::error_consistency,
                       Varmatch::parse("3>B01011<3"));
