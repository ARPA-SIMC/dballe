...
template <typename Station> BaseSummaryMemory<Station>::BaseSummaryMemory() {}
...
template <typename Station>
bool BaseSummaryMemory<Station>::stations(
...
template <typename Station>
bool BaseSummaryMemory<Station>::reports(
...
template <typename Station>
bool BaseSummaryMemory<Station>::levels(
...
template <typename Station>
bool BaseSummaryMemory<Station>::tranges(
...
template <typename Station>
bool BaseSummaryMemory<Station>::varcodes(
...
BaseSummaryMemory<Station>::query_summary(const Query& query) const
{
    return std::make_shared<summary::Cursor<Station>>(entries, query);
}

template <typename Station>
bool BaseSummaryMemory<Station>::iter(
...
template <typename Station>
bool BaseSummaryMemory<Station>::iter_filtered(
...
template <typename Station> void BaseSummaryMemory<Station>::clear()
{
...
template <typename Station>
void BaseSummaryMemory<Station>::add(const Station& station,
...
template <typename Station>
void BaseSummaryMemory<Station>::add_filtered(
    const BaseSummary<Station>& summary, const dballe::Query& query)
{
    if (const BaseSummaryMemory<Station>* s =
            dynamic_cast<const BaseSummaryMemory<Station>*>(&summary))
    {
...
template <typename Station>
void BaseSummaryMemory<Station>::add_summary(
    const BaseSummary<dballe::Station>& summary)
{
    if (const BaseSummaryMemory<dballe::Station>* s =
            dynamic_cast<const BaseSummaryMemory<dballe::Station>*>(&summary))
    {
...
{
    if (const BaseSummaryMemory<DBStation>* s =
            dynamic_cast<const BaseSummaryMemory<dballe::DBStation>*>(&summary))
    {
        entries.add(s->_entries());
        dirty = true;
    }
...
template <typename Station> void BaseSummaryMemory<Station>::commit()
{
    using namespace wreport;
    if (path.empty())
        return;
