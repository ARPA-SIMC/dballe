...
AnnotateAttrsV7::AnnotateAttrsV7(InsertAttrsV7& attrs)
    : attrs(attrs)
{
...
bool AnnotateAttrsV7::annotate(int id_data, Varcode code, const char* value)
{
...
void AnnotateAttrsV7::annotate_end()
{
...
void AnnotateAttrsV7::dump(FILE* out) const
{
    fprintf(out, "Needs insert: %d, needs update: %d\n", do_insert, do_update);
    attrs.dump(out);
}

void AttrV7::dump(FILE* out) const
{
    char flags[5];
    format_flags(flags);
...
void InsertAttrsV7::dump(FILE* out) const
{
