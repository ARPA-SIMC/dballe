#ifndef DBALLE_DB_V6_DATAV6_H
#define DBALLE_DB_V6_DATAV6_H
...
public:
    ...
    virtual void insert(dballe::db::Transaction& t, bulk::InsertV6& vars, UpdateMode update_mode=UPDATE) = 0;
