...
this->add_method("xapian_filtering_regression1", [](Fixture& f) {
    std::string json_sample = R"({"e":[{"s":{"r":"synop","c":[1234560,7654320]},"v":[{"l":[10,11,15,22],"t":[20,111,222],"v":267,"d":[[1945,4,25,8,0,0],[1945,4,25,8,0,0]],"c":1},{"l":[10,11,15,22],"t":[20,111,222],"v":268,"d":[[1945,4,25,8,0,0],[1945,4,25,8,0,0]],"c":1}]},{"s":{"r":"amdar","c":[1234560,7654320],"i":"foo"},"v":[{"l":[10,11,15,22],"t":[20,111,223],"v":268,"d":[[1945,4,25,12,0,0],[1945,4,25,12,0,0]],"c":1}]}]})";
