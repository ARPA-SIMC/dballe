...
\begin{verbatim}
c     Connect to the database and get a handle to work with it
      call idba_messaggi(handle, "file.bufr", "r", "auto", 0)
...
{\tt idba\_messaggi} has four parameters:
...
\item the report code to use to choose the output message template.  A value of
      0 means to guess automatically based on the {\tt rep\_cod} set with the
      data.
\end{enumerate}
