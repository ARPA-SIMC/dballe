...
% Editorial notes
%
%  - This guide must contain examples for all routines, plus examples for all
%    known common usage patterns of dballe
%  - It is preferred to explain concepts using commented code rather than
%    text, every time this is as understandable as normal text
%
