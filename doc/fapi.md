...
database (see [`idba_scopa`](#fun_idba_scopa)).

### Station
<a name="basic_station"></a>
...
1. A [report](#basic_report) type.
2. The [variable code](#basic_varcode).
...
<a name="fun_presentati"></a>
<a name="fun_preparati"></a>
...
is read with the functions `idba_enq*` (see [the introduction](#basics_inout)):
...
<a name="fun_quantesono"></a>
<a name="fun_elencamele"></a>
...
<a name="fun_voglioquesto"></a>
<a name="fun_dammelo"></a>
...
* `idba_scusa`:
  ...
  `idba_critica`.  By default it deletes all attributes; specific attributes to
...
explicit query for the extra station data using i`idba_voglioquesto` and
`idba_dammelo`:
...
<tbody>
  <tr><td><code>idba_seti(h, param, val)</code></td><td>Set an integer in input           </td><td><a href="#fun_set">Details</a></td></tr>
  <tr><td><code>idba_setr(h, param, val)</code></td><td>Set a real in input               </td><td><a href="#fun_set">Details</a></td></tr>
  <tr><td><code>idba_setd(h, param, val)</code></td><td>Set a double in input             </td><td><a href="#fun_set">Details</a></td></tr>
  <tr><td><code>idba_setc(h, param, val)</code></td><td>Set a character in input          </td><td><a href="#fun_set">Details</a></td></tr>
  <tr><td><code>idba_unset(h, param)    </code></td><td>Unset a value from the input      </td><td><a href="#fun_unset">Details</a></td></tr>
  <tr><td><code>idba_unsetall(h)        </code></td><td>Unset all values from the input   </td><td><a href="#fun_unsetall">Details</a></td></tr>
  <tr><td><code>idba_unsetb(h)          </code></td><td>Unset Bxxyyy values from the input</td><td><a href="#fun_unsetb">Details</a></td></tr>
  <tr><td><code>idba_enqi(h, param, val)</code></td><td>Read an integer from the output   </td><td><a href="#fun_enq">Details</a></td></tr>
  <tr><td><code>idba_enqr(h, param, val)</code></td><td>Read a real from the output       </td><td><a href="#fun_enq">Details</a></td></tr>
  <tr><td><code>idba_enqd(h, param, val)</code></td><td>Read a double from the output     </td><td><a href="#fun_enq">Details</a></td></tr>
  <tr><td><code>idba_enqc(h, param, val)</code></td><td>Read a character from the output  </td><td><a href="#fun_enq">Details</a></td></tr>
</tbody>
</table>

The following routines are shortcuts for combinations of the above ones. See
the [shortcuts section](#fun_shortcuts) for details.
...
<tbody>
<tr><td><code>idba_setcontextana(h)             </code></td><td>Set query parameters to the anagraphical context</td></tr>
<tr><td><code>idba_enqlevel(h,type1,l1,type2,l2)</code></td><td>Read level data                                 </td></tr>
<tr><td><code>idba_setlevel(h,type1,l1,type2,l2)</code></td><td>Set level data                                  </td></tr>
<tr><td><code>idba_enqtimerange(h,type,p1,p2)   </code></td><td>Read time range data                            </td></tr>
<tr><td><code>idba_settimerange(h,type,p1,p2)   </code></td><td>Set time range data                             </td></tr>
<tr><td><code>idba_enqdate(h,y,m,d,h,m,s)       </code></td><td>Read date information                           </td></tr>
<tr><td><code>idba_setdate(h,y,m,d,h,m,s)       </code></td><td>Set date information                            </td></tr>
<tr><td><code>idba_setdatemin(h,y,m,d,h,m,s)    </code></td><td>Set minimum date for a query                    </td></tr>
<tr><td><code>idba_setdatemax(h,y,m,d,h,m,s)    </code></td><td>Set maximum date for a query                    </td></tr>
</tbody>
</table>
...
<tbody>
<tr><td><code>idba_presentati(dbh,dsn,user,pwd)     </code></td><td>Connect to the database     </td><td><a href="#fun_presentati">Details</a></td></tr>
<tr><td><code>idba_preparati(dbh,h,mana,mdata,mattr)</code></td><td>Open a new session          </td><td><a href="#fun_preparati">Details</a></td></tr>
<tr><td><code>idba_messaggi(h,filename,mode,type)   </code></td><td>Work with a message file    </td><td><a href="#fun_messaggi">Details</a></td></tr>
<tr><td><code>idba_fatto(h)                         </code></td><td>Close a session             </td><td><a href="#fun_fatto">Details</a></td></tr>
<tr><td><code>idba_arrivederci(dbh)                 </code></td><td>Disconnect from the database</td><td><a href="#fun_arrivederci">Details</a></td></tr>
</tbody>
</table>
...
<tbody>
<tr><td><code>idba_scopa(h, filename)    </code></td><td>Reinitialise the database      </td><td><a href="#fun_scopa">Details</a></td></tr>
<tr><td><code>idba_quantesono(h, count)  </code></td><td>Query the stations archive     </td><td><a href="#fun_quantesono">Details</a></td></tr>
<tr><td><code>idba_elencamele(h)         </code></td><td>Fetch data about a station     </td><td><a href="#fun_elencamele">Details</a></td></tr>
<tr><td><code>idba_voglioquesto(h, count)</code></td><td>Query the data archive         </td><td><a href="#fun_voglioquesto">Details</a></td></tr>
<tr><td><code>idba_dammelo(h, param)     </code></td><td>Fetch one observed data        </td><td><a href="#fun_dammelo">Details</a></td></tr>
<tr><td><code>idba_prendilo(h)           </code></td><td>Insert values in the database  </td><td><a href="#fun_prendilo">Details</a></td></tr>
<tr><td><code>idba_dimenticami(h)        </code></td><td>Remove values from the database</td><td><a href="#fun_dimenticami">Details</a></td></tr>
<tr><td><code>idba_voglioancora(h, count)</code></td><td>Query QC data about a value    </td><td><a href="#fun_voglioancora">Details</a></td></tr>
<tr><td><code>idba_ancora(h, param)      </code></td><td>Fetch QC data                  </td><td><a href="#fun_ancora">Details</a></td></tr>
<tr><td><code>idba_critica(h)            </code></td><td>Insert QC data about a value   </td><td><a href="#fun_critica">Details</a></td></tr>
<tr><td><code>idba_scusa(h)              </code></td><td>Remove QC data                 </td><td><a href="#fun_scusa">Details</a></td></tr>
</tbody>
</table>

## Pretty printing routines

For details, see [here](#fun_pprint).
...
<tbody>
<tr><td><code>idba_spiegal(handle,ltype1,l1,ltype2,l2,string)</code></td><td>Describe a level layer</td></tr>
<tr><td><code>idba_spiegat(handle,ptype,p1,p2,string)        </code></td><td>Describe a time range </td></tr>
<tr><td><code>idba_spiegab(handle,varcode,value,string)      </code></td><td>Describe a value      </td></tr>
</tbody>
</table>

## Error management routines

For details, see [the chapter on error management](#fun_error).
...
<tbody>
<tr>
  <td><code>idba_error_code()</code></td>
  <td>Return the error code of the last function</td>
</tr>
<tr>
  <td><code>idba_error_message(msg)</code></td>
  <td>Get the error message of the last function</td>
</tr>
<tr>
  <td><code>idba_error_context(msg)</code></td>
  <td>Get the context description for the error of the last function</td>
</tr>
<tr>
  <td><code>idba_error_details(msg)</code></td>
  <td>Get details about the error of the last function</td>
</tr>
<tr>
  <td><code>idba_error_set_callback(code,fun,data,h)</code></td>
  <td>Set a callback for handling errors</td>
</tr>
<tr>
  <td><code>idba_error_remove_callback(h)</code></td>
  <td>Remove a previously set callback</td>
</tr>
<tr>
  <td><code>idba_default_error_handler</code></td>
  <td>Predefined convenience error handler</td>
</tr>
<tr>
  <td><code>idba_error_handler_tolerating_overflows</code></td>
  <td>Predefined convenience error handler that does not exist on overflow errors</td>
</tr>
</tbody>
</table>
